...
public class Challenge {
    ...
    public Challenge(String filepath) throws IOException, JavaLayerException{
       ...
       for(int i = 3; i< n_questions+3;i++)
       {
            ...
            System.out.println("=====Questao "+nq+" :=======");
             musicPath = "Challenges"+File.separator+musicsDir+File.separator+parts[0].split(",")[0];
            String imagePath = imagesDir+File.separator+parts[0].split(",")[1];
